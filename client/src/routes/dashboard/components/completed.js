        ...
        <div className={styles.sales}>
            ...
            <ResponsiveContainer minHeight={360}>
                <AreaChart data={data}>
                    ...
                    <Tooltip
                        wrapperStyle={{ border: 'none', boxShadow: '5px 6px 50px rgba(0, 0, 0, 0.05)' }}
                        content={(content) => {
                    ...
                    />
                    <Area type="monotone" dataKey="Task complete" stroke={color.green} fill={color.green} strokeWidth={2} dot={{ fill: '#fff' }} activeDot={{ r: 5, fill: '#fff', stroke: color.green }} />
